...
# --- Важно: обработчики «команд во время ввода контакта» выше основного валидатора ---

# Если пользователь прислал команду (например, /start) на шаге контакта — выходим из регистрации
...
# Можно ещё ловить слова «отмена», «cancel», чтобы выйти по тексту (не обязательно)
